  ...
  return (
    <li
      ...
      className={classNames(className, {
        todo__list__allTask: type === "allTask",
        todo__list__add: type === "addFolder",
      })}>
      <div className='todo__list__iconWraper'>
        {color ? (
          <span
            style={{ background: color }}
            alt='color-category'
            className='todo__list__icon '
          />
        ) : (
          image
        )}
      ...
      {isRemovable && (
        <svg
          ...
          viewBox='0 0 21 21'
          fill='none'
          className='todo__list__closeSvg'
